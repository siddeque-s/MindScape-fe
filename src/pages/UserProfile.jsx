    ...
    <>
      ...
      <div className={sec1Style()}>
        ...
        <section className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-xl border border-emerald-100 text-center">
          ...
          <p className="mt-4 text-green-700 font-semibold bg-green-100 inline-block px-4 py-2 rounded-full">
            ✔ Doctor Assigned
          </p>
        </section>

        {/* sec2 activity summary */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-md text-center hover:shadow-xl transition">
              <img
                ...
                alt=""
              />
              <h3 className="text-emerald-800 font-semibold text-lg">Habits</h3>

              {/* MAPhabits */}
              <p className="text-gray-700 font-bold text-2xl">24</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md text-center hover:shadow-xl transition">
              ...
              {/* map moof logs */}
              <p className="text-gray-700 font-bold text-2xl">12</p>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-md text-center hover:shadow-xl transition">
              <img
                className="w-12 mx-auto mb-2"
                src="https://cdn-icons-png.flaticon.com/512/4201/4201498.png"
                alt=""
              />
              <h3 className="text-emerald-800 font-semibold text-lg">
                Stress Logs
              ...
              {/* map stress log */}
              <p className="text-gray-700 font-bold text-2xl">8</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md text-center hover:shadow-xl transition">
              ...
              {/* map journal */}
              <p className="text-gray-700 font-bold text-2xl">19</p>
            </div>
          </div>
        </section>
